...
namespace WebKillaDeco.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(KillaDbContext context, IWebHostEnvironment webHostEnvironment)
        {
            _context = context;
        ...
        [ValidateAntiForgeryToken]
        [Authorize]
        public async Task<IActionResult> Edit(int id, [Bind("ProductId,SubCategoryId,Sku,Name,Description,CurrentPrice,Active,ImageUrl,AvailableStock,Weight,Dimensions,Color,PublicationDate,Discount")] Product product)
        {
